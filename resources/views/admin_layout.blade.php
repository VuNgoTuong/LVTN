        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-phim')}}">Liệt Kê danh mục phim</a></li>
                    </ul>
                </li> 
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-suatchieu')}}">Liệt Kê suất chiếu</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý Hóa đơn Vé</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/manager-ve')}}">Liệt Kê vé</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-theloaiphim')}}">Liệt Kê thể loại</a></li>
                    </ul>
                </li> 
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-dangphim')}}">Liệt Kê dạng phim</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-rap')}}">Liệt Kê Rạp</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-phong')}}">Liệt Kê Phòng</a></li>
                    </ul>
                </li>
              <!--   <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-thanhpho')}}">Liệt Kê Thành Phố</a></li>
                    </ul>
                </li> -->
             ...
             <!--    <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-tintuc')}}">Thêm Tin khuyến mãi</a></li> 
						<li><a href="{{URL::to('/all-tintuc')}}">Liệt kê danh sách Tin</a></li>
                    </ul>
                </li> -->
			...
			<!-- 	<li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="glyphicon.html">Liệt Kê tài khoản</a></li>
                    </ul>
                </li> -->
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/manager-khachhang')}}">Liệt Kê tài khoản khách hàng</a></li>
                    </ul>
                </li>
            </ul>            </div>
        <!-- sidebar menu end-->
